  ...
  return (
    <>
      ...
      <div className="hidden bg-black">
        <div
          className={`${louizeFont.variable} ml-16 flex h-screen flex-col`}
            ...
            <div className="flex w-full items-center justify-between px-8 py-4">
              <div className="relative flex w-full items-center">
                <Input
                  type="search"
                  placeholder="Search..."
                  className="w-full rounded-none border-0 border-b-2 bg-transparent px-2 py-4 font-serif text-6xl transition-colors focus:ring-0"
                  style={{
                ...
                {searchTerm && (
                  <Button
                    ...
                    className="absolute right-4 top-1/2 h-6 w-6 -translate-y-1/2 transform p-0"
                  />
                )}
              </div>
            </div>
          ...
          <div className="flex-grow overflow-hidden">
            <div className="h-full overflow-y-auto p-8">
              {isLoading ? (
                ...
                <div className="grid min-h-full grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                  <NoteEditorTile
