      ...
      <div className="min-h-screen bg-[#09090B]">
        <div className="mx-auto p-6">
          <div className="rounded-lg bg-[#1C1C1E] p-6">
            ...
            <Link
              href="/meetings"
              className="flex items-center gap-2 text-[#9334E9] transition-colors hover:text-purple-300"
            >
    ...
    <>
      <div className="min-h-screen bg-black">
        <div className="mx-auto p-6">
          ...
          {isModalOpen && (
            ...
            >
              <div className="rounded-lg border border-white/20 bg-black bg-opacity-40 p-8 shadow-lg backdrop-blur-sm">
                ...
                {/* Horizontal Divider */}
                <div className="my-6 hidden border-t border-white/20"></div>

                {/* Copy Link Section */}
                <div>
                  <p className="lg:text-md hidden text-sm font-semibold text-white">
                  ...
                  <input
                    ...
                    readOnly
                    className="mt-2 w-[30%] rounded-[8px] border border-[#27272A] bg-transparent px-4 py-2 text-sm text-zinc-400 focus:outline-none"
                  ...
                  />
                  <button
                    className="mt-2 inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md border border-white/10 bg-[#3c1671] px-4 py-2 text-xs font-normal text-[#FAFAFA] transition-all duration-200 hover:border-[#6D28D9] hover:bg-[#3c1671] lg:px-4 lg:py-2"
                ...
                {/* Horizontal Divider */}
                <div className="my-6 hidden border-t border-white/10"></div>
          ...
          {isPreviewModalOpen && (
            <div
              className="fixed inset-0 z-[1000] flex items-center justify-center bg-black bg-opacity-50 px-2"
              onClick={(e) => {
                if (e.target === e.currentTarget) {
                  setIsPreviewModalOpen(false);
                }
            ...
            >
              <div className="flex max-h-[80vh] w-[90%] max-w-4xl flex-col rounded-lg border border-white/20 bg-black bg-opacity-40 p-8 shadow-lg backdrop-blur-sm">
                <h2 className="text-md mb-4 font-medium text-white lg:text-xl">
                  Full transcript
                </h2>

                <div className="mb-4 flex-grow overflow-auto rounded-lg bg-[#27272A] p-4">
                  {isLoadingPreview ? (
                    ...
                    <div className="relative">
                      <div
                        className="absolute right-1 top-1 cursor-pointer rounded border border-[#303032] bg-[#18181B] p-1.5 transition-colors hover:bg-[#27272A]"
                        onClick={() => {
          ...
          <div
            className={`fixed right-0 top-0 z-50 h-full w-[450px] transform border-l border-zinc-800 bg-black transition-transform duration-300 ease-in-out lg:block ${
          ...
          >
            <div className="flex h-full flex-col">
              ...
              <div className="flex items-center justify-between border-b border-zinc-800 p-4">
                <button
                  className="flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-zinc-900 px-4 py-2 text-sm font-normal text-white transition-all duration-200 hover:border-[#6D28D9]"
                ...
                <button
                  ...
                  className="text-zinc-400 transition-colors hover:bg-[#27272A]"
                >
                  <svg
                    width="24"
                    height="24"
              ...
              {/* Chat Messages */}
              <div className="flex-1 space-y-4 overflow-y-auto p-4 font-poppins">
                <div className={`flex justify-start`}>
                  <div className={`text-md max-w-[80%] rounded-3xl text-white`}>
                ...
                {chatMessages.map((message, index) => (
                  ...
                  >
                    <div
                      className={`text-md max-w-[80%] rounded-3xl ${
                        message.role === "user"
                          ? "bg-[#6D28D9] px-4 py-2 text-white"
                          : "text-white"
                      }`}
                    >
                      {message.content}
              ...
              <form
                ...
                className="mr-14 border-t border-zinc-800 p-4"
              >
                <div className="flex w-full items-center">
                  ...
                  <button
                    ...
                    className={`rounded-r-lg border-b border-r border-t border-zinc-800 bg-black p-3 text-zinc-300 md:p-4 ${
          ...
          {/* Mobile Chat Popup */}
          {isMobile && isChatOpen && (
            <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black bg-opacity-80 p-4">
              <div className="flex h-[90vh] w-full max-w-md flex-col rounded-xl border border-zinc-800 bg-black">
                {/* Chat Popup Header */}
                <div className="flex items-center justify-between border-b border-zinc-800 p-4">
                  <h2 className="font-medium text-white">Chat with Meeting</h2>
                  <button
                    onClick={() => setIsChatOpen(false)}
                    className="rounded-full p-2 text-zinc-400 transition-colors hover:bg-[#27272A]"
                  >
                    <svg
                      width="20"
                      height="20"
                ...
                <div className="flex-1 space-y-4 overflow-y-auto p-4 font-poppins">
                  <div className={`flex justify-start`}>
                    ...
                    >
                      Hey, I&apos;m ready to help you with any questions you
                      have about this meeting. What can I do for you?
                    </div>
                  </div>
                  ...
                  <div className="flex w-full items-center">
                    <div className="relative flex flex-1 items-center">
                      ...
                      <input
                        ...
                        onChange={(e) => setChatInput(e.target.value)}
                        placeholder="Type your message..."
                        className="flex-1 rounded-l-lg border border-zinc-800 bg-black p-3 pl-10 text-sm text-zinc-300 transition-colors focus:border-[#6D28D9] focus:outline-none"
                      />
                    </div>
                    <button
                      type="submit"
                      disabled={!chatInput.trim() || isSending}
                      className={`rounded-r-lg border-b border-r border-t border-zinc-800 bg-black p-3 text-zinc-300 ${
                        !chatInput.trim() || isSending
                          ? "cursor-not-allowed"
                          : "hover:bg-[#3c1671]"
                      } transition-colors`}
          ...
          >
            <div className="mb-6 flex items-center justify-between">
              <Link
                href="/meetings"
                className="flex items-center gap-2 text-sm text-zinc-400 transition-colors hover:text-white lg:text-base"
              >
                <ArrowLeft className="h-4 w-4" />
                Back to Meetings
              </Link>
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-4 text-sm text-zinc-400">
                  <div className="hidden items-center gap-2 border-r border-zinc-800 pr-4">
            ...
            {/* mobile  */}
            <div className="mx-auto mb-4 flex flex-col items-center justify-center md:hidden">
              <button
                className="mx-auto mt-2 flex inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-lg border border-white/10 bg-[#6D28D9] px-4 py-2 text-xs font-normal text-[#FAFAFA] transition-all duration-200 hover:border-[#6D28D9] hover:bg-[#3c1671] md:hidden"
            ...
            {/* desktop */}
            <div className="mx-auto mb-4 flex hidden flex-col items-center justify-center lg:flex">
              <span className="text-sm font-medium text-white md:text-lg">
                Make this meeting public
              </span>
              <div className="mx-auto flex w-[100%] items-center justify-center gap-4">
                <input
                  type="text"
                  value={`${window.location.host.includes("localhost") ? "http://" : "https://"}${window.location.host}/shared/${params.id}`}
                  readOnly
                  className="mt-2 hidden w-[30%] rounded-lg border border-[#27272A] bg-transparent px-4 py-2 text-sm text-zinc-400 focus:outline-none md:block"
                  onClick={(e) => e.target.select()}
                  style={{
                    userSelect: "none",
                    outline: "none",
                ...
                />
                <button
                  className="md:text-md mt-2 inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-lg border border-white/10 bg-[#6D28D9] px-4 py-2 text-xs font-normal text-[#FAFAFA] transition-all duration-200 hover:border-[#6D28D9] hover:bg-[#3c1671] lg:px-4 lg:py-2"
                  onClick={handleCopyLink}
                >
                  <svg
                    width="15"
              ...
              <div className="hidden border-b border-zinc-800 p-6 lg:block">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button
                      className={`${isChatOpen ? "hidden" : ""} text-md inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-lg border border-white/10 bg-[#6D28D9] px-2 py-2 font-normal text-[#FAFAFA] transition-all duration-200 hover:border-[#6D28D9] hover:bg-[#3c1671] lg:px-4 lg:py-2`}
                      onClick={() => setIsChatOpen(true)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="space-y-6 p-6">
                {transcript.actionItems && (
                  <div onClick={handleActionItemClick}>
                    <div className="flex items-center justify-between">
                      <h2 className="text-md mb-3 font-normal text-[#6D28D9] lg:text-xl">
                        Action Items
                      </h2>
                    </div>
                    ...
                    <button
                      ...
                      className="mt-4 flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-zinc-900 px-4 py-2 text-xs font-medium text-white transition-all duration-200 hover:border-[#6D28D9]"
                    >
                      <svg
                        width="15"
                        height="15"
                ...
                {transcript.summary && (
                  <div onClick={handleSummaryClick}>
                    <div className="flex items-center justify-between">
                      <h2 className="text-md mb-3 font-medium text-[#6D28D9] lg:text-xl">
                        Meeting Summary
                      </h2>
                    </div>
                    ...
                    <button
                      onClick={(e) => {
                        ...
                        setTimeout(
                          () => setCopyMeetingSummaryText("Copy"),
                          3000
                        );
                      }}
                      className="mt-4 flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-zinc-900 px-4 py-2 text-xs font-medium text-white transition-all duration-200 hover:border-[#6D28D9]"
