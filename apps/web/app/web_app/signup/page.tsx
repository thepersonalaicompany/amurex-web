...
export default function SignUp(): JSX.Element {
  ...
  const createUserEntry = async (
    userId: string,
    userEmail: string | undefined = email,
    googleTokens: GoogleTokens | null = null,
  ): Promise<void> => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 left-4 z-10 flex items-center md:top-6 md:left-6">
        <img
          src="/amurex.png"
          alt="Amurex logo"
      ...
      <div className="w-full max-w-lg max-w-[95%]">
          ...
          {!showEmailForm ? (
            <>
              <button
                ...
                className="font-normal mb-6 flex w-full items-center justify-center gap-2 rounded-lg !bg-white p-2.5 text-sm text-[#0E0F0F] transition-all duration-200 hover:!bg-gray-300 md:p-3 md:text-base"
                style={{ fontFamily: "var(--font-noto-serif)" }}
              >
            ...
            <>
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full rounded-lg border border-zinc-400 bg-[#9334E9] p-2.5 text-md font-light text-[#FAFAFA] transition-all duration-200 hover:border-[#6D28D9] hover:bg-[#3c1671]"
                >
