...
export default function SignIn(): JSX.Element {
  ...
  const [isExtensionAuth, setIsExtensionAuth] = useState<boolean>(false);
  const router = useRouter();
  const signupRedirect = "/web_app/signup";
      ...
      <div className="w-full max-w-[95%] md:max-w-md">
        ...
        <div className="w-full rounded-lg bg-[#0E0F0F] p-6 shadow-lg backdrop-blur-sm md:p-8">
          <div className="mb-6 text-center md:mb-8">
            <h1
              className="font-serif text-3xl text-white md:text-4xl mb-2"
